namespace UnityEngine.Rendering.URP
{
    ...
    internal class BlitPass : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {
        ...
        /// </summary>
        public BlitPass(UnityEngine.Rendering.Universal.RenderPassEvent renderPassEvent, Material blitMaterial, int blitShaderPassIndex, LayerMask LayerMask, string tag)
        {
